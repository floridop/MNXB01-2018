...
#
# Student: Daniel Nastasijevic Sadly I had a little to much to do in the 
#other course im taking and did not manage to complete this asignment on time-
#and quite frankly I have quite a few problems understanding how to go about these excersises.
#
...
#
# Datastructure format is 	a string____________________
