...
###############################################################################
# 
# Fortuneteller - MNXB01-2018 Homework
#
...
FTTEMPDIR=`mktemp -p /tmp -d ftellerXXX`
...
wget -q -O $FTTEMPDIR/fortunes 'http://fortunecookieapi.herokuapp.com/v1/fortunes'
...
cat $FTTEMPDIR/fortunes | json_pp -t json > $FTTEMPDIR/fortunes_pp
...
NUMMSG=`wc -l $FTTEMPDIR/fortunes_messages | cut -f1 -d' '`
