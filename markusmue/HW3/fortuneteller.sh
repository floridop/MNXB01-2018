...
#
# Datastructure format is .json (JavaScript)
...
NUMMSG=$(wc ${FTTEMPDIR}/fortunes_messages | cut -d' ' -f 2 ) 

#wc ${FTTEMPDIR}/fortunes_messages | cut -d' ' -f 2 > ${FTTEMPDIR}/lines.txt
